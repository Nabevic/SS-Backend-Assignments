...
course.route('/enrollment/delete/<padawan_id>', methods=['DELETE'])
def remove_padawan_enrollment_route(padawan_id):
  controllers.remove_padawan_enrollment(padawan_id)